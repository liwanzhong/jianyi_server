...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/instrument/checksmallitem/edit.js"></script>
...
<form id="form" name="form" class="form-horizontal" method="post"  action="${ctx}/enterprise/editEntity.shtml">
