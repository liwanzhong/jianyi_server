...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/instrument/checkbigitem/edit.js"></script>
...
<form id="form" name="form" class="form-horizontal" method="post"  action="${ctx}/instrument/bigitem/editEntity.shtml">
