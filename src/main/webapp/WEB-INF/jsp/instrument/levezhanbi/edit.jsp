		...
		<form id="userEditForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					<td>正常占比</td>
					<td colspan="3">
						<input name="checkItemDegrLeveZhanbiFormMap.leve_1_procent" onchange="procentCount()" placeholder="占比(0-100)" type="text"  style="height: 29px;" class="easyui-validatebox" data-options="required:true" value="${checkItemDegrLeveZhanbiFormMap.leve_1_procent}">%
					</td>
				</tr>
				<tr>
					<td>未见异常占比</td>
					<td colspan="3">
						<input name="checkItemDegrLeveZhanbiFormMap.leve_2_procent" onchange="procentCount()" placeholder="占比(0-100)" type="text"  style="height: 29px;" class="easyui-validatebox" data-options="required:true" value="${checkItemDegrLeveZhanbiFormMap.leve_2_procent}">%
					</td>
				</tr>
				<tr>
					<td>减弱一级占比</td>
					<td colspan="3">
						<input name="checkItemDegrLeveZhanbiFormMap.leve_3_procent" onchange="procentCount()" placeholder="占比(0-100)" type="text"  style="height: 29px;" class="easyui-validatebox" data-options="required:true" value="${checkItemDegrLeveZhanbiFormMap.leve_3_procent}">%
					</td>
				</tr>
				<tr>
					<td>减弱二级占比</td>
					<td colspan="3">
						<input name="checkItemDegrLeveZhanbiFormMap.leve_4_procent" onchange="procentCount()" placeholder="占比(0-100)" type="text"  style="height: 29px;" class="easyui-validatebox" data-options="required:true" value="${checkItemDegrLeveZhanbiFormMap.leve_4_procent}">%
					</td>
				</tr>
				<tr>
					<td>减弱三级占比</td>
					<td colspan="3">
						<input name="checkItemDegrLeveZhanbiFormMap.leve_5_procent" onchange="procentCount()" placeholder="占比(0-100)" type="text"  style="height: 29px;" class="easyui-validatebox" data-options="required:true" value="${checkItemDegrLeveZhanbiFormMap.leve_5_procent}">%
					</td>
				</tr>
			</table>
		</form>
