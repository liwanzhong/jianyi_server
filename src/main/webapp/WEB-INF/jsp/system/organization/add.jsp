...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#organizationAddForm').form({
			url : '${ctx}/organization/add.shtml',
			onSubmit : function() {
				progressLoad();
...
<div style="padding: 3px;">
	<form id="organizationAddForm" method="post">
		<table class="grid">
			<tr>
				<td>编号</td>
				<td><input name="organizationFormMap.code" type="text" placeholder="请输入组织编号" class="easyui-validatebox" data-options="required:true" ></td>
				<td>组织名称</td>
				<td><input name="organizationFormMap.name" type="text" placeholder="请输入组织名称" class="easyui-validatebox" data-options="required:true" ></td>
			</tr>
			<tr>
				<td>排序</td>
