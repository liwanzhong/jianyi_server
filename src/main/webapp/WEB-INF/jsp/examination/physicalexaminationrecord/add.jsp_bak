...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/examination/physicalexaminationrecord/add.js">
...
<form id="form" name="form" class="form-horizontal" method="post"  action="${ctx}/examination/physicalExamination/addEntity.shtml">
