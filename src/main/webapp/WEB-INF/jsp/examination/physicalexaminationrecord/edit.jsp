...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/examination/physicalexaminationrecord/edit.js"></script>
...
<form id="form" name="form" class="form-horizontal" method="post"  action="${ctx}/examination/physicalExamination/editEntity.shtml">
