...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/examination/physicalexaminationrecord/list.js"></script>
</head>
...
<div class="nav">
    <div class="wrap">
        <ul class="clearfix">
            <li><a href="${ctx}/custom/info/list_client.shtml" >用户管理</a></li>
            <li><a href="${ctx}/examination/physicalExamination/client_list.shtml" class="current">检测管理</a></li>
            <li><a href="#">产品管理</a></li>
        </ul>
    </div>
</div>
