...
<div class="wrap">
    ...
    <div class="w">
        ...
        <!--details-->
        <div class="details">${physicalExaminationMainReportFormMap.with_flow}</div>
        <!--main-->
        <div class="body-bg">
            <!--grade-->
            <div class="grade clearfix">
                <div class="grade-1">
                    <ul>
                        <li class="s-pic-green"></li>
                        <li class="s-pic-blue"></li>
                        <li class="s-pic-yellow"></li>
                        <li class="s-pic-orange"></li>
                        <li class="s-pic-red"></li>
                    </ul>
                </div>
                <div class="grade-2">
                ...
                <div class="grade-4" style="margin-right:0;">
                    <ul>
                        ...
                        <li style="color:#27930b;">标准体重：<span>60-66.5</span>KG</li>
                        <li style="color:#f00; font-size:16px;">肥胖</li>
                    </ul>
                </div>
